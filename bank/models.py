...
class Transaction(db.Model):
    ...
    src_acnt= db.Column(db.Integer, db.ForeignKey('account.acnt_id'))
    trgt_acnt= db.Column(db.Integer, primary_key=True)